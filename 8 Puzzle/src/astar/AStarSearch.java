...
public class AStarSearch extends ArrayList<String> {
	/**
	 * 
	 */
	private static final long serialVersionUID = -3387730719127018626L;

	public AStarSearch(State init, String heurestic){
		super();
		addAll(aStarSearch(init, heurestic));
	}
	
	public static ArrayList<String> aStarSearch(State init, String heurestic)
	{
		// Create a node
		Node initial = new Node(init);
		initial.calculateCost(heurestic);
